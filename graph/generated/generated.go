...
func (ec *executionContext) field_Mutation_createDog_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewDog2githubᚗcomᚋMarlosᚑRodriguezᚋGo_MongoDB_GraphQLᚋgraphᚋmodelᚐNewDog(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createDog(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNDog2ᚖgithubᚗcomᚋMarlosᚑRodriguezᚋGo_MongoDB_GraphQLᚋgraphᚋmodelᚐDog(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_dogs(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Dog)
	fc.Result = res
	return ec.marshalNDog2ᚕᚖgithubᚗcomᚋMarlosᚑRodriguezᚋGo_MongoDB_GraphQLᚋgraphᚋmodelᚐDogᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNDog2githubᚗcomᚋMarlosᚑRodriguezᚋGo_MongoDB_GraphQLᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v model.Dog) graphql.Marshaler {
	return ec._Dog(ctx, sel, &v)
}

func (ec *executionContext) marshalNDog2ᚕᚖgithubᚗcomᚋMarlosᚑRodriguezᚋGo_MongoDB_GraphQLᚋgraphᚋmodelᚐDogᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Dog) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNDog2ᚖgithubᚗcomᚋMarlosᚑRodriguezᚋGo_MongoDB_GraphQLᚋgraphᚋmodelᚐDog(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNDog2ᚖgithubᚗcomᚋMarlosᚑRodriguezᚋGo_MongoDB_GraphQLᚋgraphᚋmodelᚐDog(ctx context.Context, sel ast.SelectionSet, v *model.Dog) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNNewDog2githubᚗcomᚋMarlosᚑRodriguezᚋGo_MongoDB_GraphQLᚋgraphᚋmodelᚐNewDog(ctx context.Context, v interface{}) (model.NewDog, error) {
